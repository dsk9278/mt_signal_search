...
class SignalSearchService:
    ...
    def set_logic_expr(self, signal_id: str, raw_expr: str, source_label: str = "(ui)",
...
class FavoritesService:
    ...
    def toggle_favorite(self, logic_name: str) -> bool:
        return self._repo.remove_favorite(logic_name) if self._repo.is_favorite(logic_name) else self._repo.add_favorite(logic_name)
    def get_favorites(self): return self._repo.get_favorites()
    def is_favorite(self, logic_name: str): return self._repo.is_favorite(logic_name)
